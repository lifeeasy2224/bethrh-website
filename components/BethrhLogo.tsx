// 📁 FILE: src/components/BethrhLogo.tsx
...
const BethrhLogo: React.FC<BethrhLogoProps> = ({ size = 'md', color = '#D4A653' }) => {
  const widths: Record<LogoSize, number> = { sm: 140, md: 200, lg: 320 };
  const heights: Record<LogoSize, number> = { sm: 88, md: 124, lg: 212 };
  ...
  return (
    ...
    >
      {/* Open-top shield — two vertical lines, NO top bar */}
      ...
      <path
        d="M52,188 Q52,280 160,310 Q268,280 268,188"
        fill="rgba(212,166,83,0.04)"
        stroke={color}
        strokeWidth="2"
      />

      {/* Inner shield — subtle echo */}
      ...
      <path
        d="M68,185 Q68,260 160,288 Q252,260 252,185"
        fill="none"
        stroke={`${color}28`}
        strokeWidth="0.8"
      />
      ...
      {/* BETHRH — Montserrat English, muted */}
      <text
        x="160"
        y="228"
        textAnchor="middle"
