...
// ─────────────────────────────────────────
// Embeds Google Fonts @import inside SVG <defs>
// so Noto Kufi Arabic renders correctly everywhere:
// website, GitHub preview, emails, PDFs, social
// ─────────────────────────────────────────
...
export default function BethrhLogo({
  ...
  return (
    <svg
      ...
      role="img"
    >
      {/* ── Embed Noto Kufi Arabic + Montserrat directly in SVG ── */}
      <defs>
        <style>{`
          ...
          .bethrh-ar {
            font-family: 'Noto Kufi Arabic', 'Arabic Typesetting', 'Simplified Arabic', sans-serif;
            font-weight: 700;
          }
          .bethrh-en {
      ...
      {/* ── Open-top shield: two vertical lines + bottom curve ── */}
      {/* NO top bar — open at the top like a gateway */}
      ...
      <path
        d="M52,118 Q52,178 160,196 Q268,178 268,118"
        fill={`${color}08`}
        stroke={color}
        strokeWidth="2"
        strokeLinecap="round"
      ...
      <path
        d="M68,115 Q68,166 160,182 Q252,166 252,115"
        fill="none"
        stroke={`${color}22`}
        strokeWidth="0.8"
      />
      ...
      {/* ── بذرة wordmark — Noto Kufi Arabic 700 ── */}
      <text
        x="160"
        y="98"
        textAnchor="middle"
