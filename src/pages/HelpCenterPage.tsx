...
const ARTICLES: Article[] = [
  ...
  { id: 'cost', category: 'getting-started', title: 'كم تكلّف؟', content: 'مجاني ($0): استكشف المنصة، وتصفّح مكتبة الأفكار، والتقط فكرة واحدة مع تحقق أساسي. برو ($9/شهر): تفاصيل الأفكار كاملة، والتقاط غير محدود، ومدرب AI بـ ٥٠ رسالة/يوم، ونموذج الإيرادات، وتتبع الـ ٩٠ يوماً. نمو ($19/شهر): كل ما في برو + مدرب AI بـ ٢٠٠ رسالة/يوم، وPitch Deck AI، وربط مع المستثمرين. المسرعات: حلول مخصصة — تواصل معنا.' },
