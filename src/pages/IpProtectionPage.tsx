      ...
      <Box sx={{ pt: { xs: 10, md: 12 }, pb: 8, flex: 1 }}>
        <Container maxWidth="md">
          ...
          {[
            ...
            { h: 'سياسة DMCA', p: 'إذا كنت تعتقد أن محتوى على بذرة ينتهك ملكيتك الفكرية، راسل hello@bethra.co مع تفاصيل الانتهاك المزعوم.' },
            { h: 'التواصل', p: 'Life Easy LLC · hello@bethra.co · +1 (480) 447-6256' },
          ].map(s => (
            <Box key={s.h} sx={{ mb: 3 }}>
