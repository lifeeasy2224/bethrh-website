      ...
      <Box sx={{ pt: { xs: 10, md: 12 }, pb: 8, flex: 1 }}>
        <Container maxWidth="md">
          ...
          {[
            ...
            { h: 'حقوقك', p: 'يمكنك طلب الاطلاع على بياناتك الشخصية أو تصحيحها أو حذفها في أي وقت عبر مراسلة info@bethra.co. سنرد خلال ٣٠ يوماً.' },
            { h: 'التواصل', p: 'Life Easy LLC · 44887 W Bahia Dr · Maricopa AZ 85139 · info@bethra.co · +1 (480) 447-6256' },
          ].map(s => (
            <Box key={s.h} sx={{ mb: 3 }}>
